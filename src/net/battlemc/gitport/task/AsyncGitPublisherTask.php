...
namespace net\battlemc\gitport\task;

use net\battlemc\gitport\classes\GitRepository;
use net\battlemc\gitport\classes\GitRepositoryQueue;
use net\battlemc\gitport\GitPort;
...
class AsyncGitPublisherTask extends AsyncTask
{
	...
	public function onCompletion(Server $server)
	{
		foreach ($this->getResult() as $plugin) {
			$plugin = $server->getPluginManager()->loadPlugin($plugin . ".phar");
